...
| :--- | :--- |
| **1. Diagnostics Check** | **Mac/Linux:** `python3 .cursor/skills/vnstock-env-setup/scripts/diagnostics.py`<br>**Win:** `py .cursor/skills/vnstock-env-setup/scripts/diagnostics.py` (if `py` fails, test `python`) |
...
| **7. Agent Guide Install** | **Mac/Linux:** `python3 .cursor/skills/vnstock-env-setup/scripts/setup_agent_guide.py --confirm-docs-overwrite`<br>**Win:** `py .cursor/skills/vnstock-env-setup/scripts/setup_agent_guide.py --confirm-docs-overwrite` |
...
| Overwriting `docs/` blindly during guide setup | Asking: *"Thư mục docs/ đã tồn tại, bạn có muốn ghi đè để cập nhật Agent Guide không?"* |
...
```bash
# Mac/Linux
python3 .cursor/skills/vnstock-env-setup/scripts/diagnostics.py

# Windows
# Note: Try 'py' first to avoid Windows Store aliases. If it fails, fallback to 'python' or prompt user.
py .cursor/skills/vnstock-env-setup/scripts/diagnostics.py
```
...
python3 .cursor/skills/vnstock-env-setup/scripts/setup_agent_guide.py

```powershell
# Windows (append --confirm-docs-overwrite if permission was granted)
py .cursor/skills/vnstock-env-setup/scripts/setup_agent_guide.py
```
